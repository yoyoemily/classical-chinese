...
# ============================================================
# 词书导入工具
#   ./import_wordbook.sh             引导选择：全部导入或指定单本
...
echo ""
echo "   [A] 全部导入（共 ${#ALL_BOOKS[@]} 本）"
echo "   [1] wb_zhongkao_shixu      — 中考实词虚词一本通"
echo "   [2] wb_zhongkao_tongjia    — 中考通假字一本通"
echo "   [3] wb_zhongkao_gujinyi    — 中考古今异义一本通"
echo "   [4] wb_zhongkao_cileihuoyong — 中考词类活用一本通"
echo "   [5] wb_gaokao_shixu        — 高考实词虚词一本通"
echo "   [6] wb_gaokao_tongjia      — 高考通假字一本通"
echo "   [7] wb_gaokao_gujinyi      — 高考古今异义一本通"
echo "   [8] wb_gaokao_cileihuoyong — 高考词类活用一本通"
echo "   [9] wb_function_words       — 文言文虚词深度解析"
echo "   [Q] 退出"
echo ""

read -r -p "请选择 (A/1-9/Q): " CHOICE
